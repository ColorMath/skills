...
The mock in this case declares exactly 6, and these are they:
`blast_radius`, `reversibility`, `data_and_migration`, `security_and_authorization`, `external_dependency`, `operational_load`. The legal levels are `low`, `medium` and `high`.
